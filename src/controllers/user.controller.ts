...
import { findUserByIdOrUsername, findAllUsers } from "../repositories/user.repository";
...
export const getUserByIdOrUsernameController = async (req: Request, res: Response) => {
